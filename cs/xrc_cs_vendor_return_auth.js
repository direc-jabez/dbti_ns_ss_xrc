    ...
    function (currRec, url) {
        ...
        function onSubmitForApprovalBtnClick() {
            ...
            if (!g_isSubmitForApprovalBtnClick) {
                ...
                window.location.href = "https://9794098.app.netsuite.com/app/site/hosting/restlet.nl?script=1537&deploy=1&action=submitforapproval&id=" + currentRecord.id;
        ...
        function onApproveBtnClick(approve_field) {
            ...
            if (!g_isApproveBtnClick) {
                ...
                // Redirect to the approval link
                window.location.href = "https://9794098.app.netsuite.com/app/site/hosting/restlet.nl?script=1537&deploy=1&action=approve&id=" + currentRecord.id + "&field=" + approve_field;
        ...
        function onRejectBtnClick() {
            ...
            if (!g_isRejectBtnClick) {
                ...
                // Redirect to the approval link
                window.location.href = "https://9794098.app.netsuite.com/app/site/hosting/restlet.nl?script=1537&deploy=1&action=reject&id=" + currentRecord.id;
        ...
        function onPrintButtonClick() {
            ...
            var suiteletUrl = url.resolveScript({
                scriptId: 'customscript_xrc_sl_print_vra',
                deploymentId: 'customdeploy_xrc_sl_print_vra',
