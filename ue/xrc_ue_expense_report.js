    ...
    function (record, search, runtime) {
        ...
        function beforeLoad(context) {
            ...
            if (context.type !== context.UserEventType.DELETE) {
                ...
                if (approval_status === STATUS_PENDING_APPROVAL) {
            ...
            if (context.type === context.UserEventType.VIEW) {
                ...
                // Adding button Submit for Aprpoval
                if (approval_status === STATUS_APPROVED && (runtime.getCurrentUser().role === AP_SAO_ID || runtime.getCurrentUser().role === AP_AH_ID || runtime.getCurrentUser().role === AP_CLERK_ID)) {
                    form.addButton({
